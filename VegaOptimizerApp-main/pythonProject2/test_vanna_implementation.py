...
def test_vanna_calculation():
    ...
    # Vanna should be positive for OTM calls (S < K, D2 < 0)
    if vanna > 0:
        print("  ✅ Vanna is positive (expected for OTM call)")
    else:
        print("  ❌ Vanna should be positive for OTM call")
...
def test_real_options_data():
    ...
    try:
        ...
        ticker = "AAPL"
        expiration = "2025-02-21"  # Use a future date
